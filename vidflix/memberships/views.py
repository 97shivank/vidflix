...
def updateTransactions(request):
	...
	user_membership.memberships = selected_membership
	...
	messages.info(request, "Sucessfully created {} membership".format(selected_membership))
...
def cancelSubscription(request):
	...
	if user_sub.active == False:
		...
		messages.info(request, "Sucessfully cancelled membership")
